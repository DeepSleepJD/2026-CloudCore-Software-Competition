...
下载 [比赛提交包 CoreGeek.tar.gz](artifacts/CoreGeek.tar.gz) 的文件本体上传，勿上传 GitHub 整个仓库源码压缩包。详细行为和限制见 [v7 交付说明](docs/v7-delivery.md)，验证见 [v7 冒烟记录](production/qa/smoke-v7-2026-09-18.md)。
...
将 8080 替换为平台分配的端口。Python 3.10+，仅标准库，监听 `0.0.0.0`。日志输出到标准输出；GET 健康检查显示 `v7-jd`、请求数、最近回合、动作数及异常类型。
